...
const postData = [
  {
    ...
    post_title: '5 resons why I love JavaScript',
    post_contents: `1. Its easy to learn, 
  ...
  },
  {
    ...
    post_title: 'SQL vs NoSQL',
    post_contents: `1. SQL databases are relational, NoSQL are non-relational.
  ...
  },
  {
    ...
    post_title: 'Top 5 reasons why using BootStrap is advantageous',
    post_contents: `1. Bootstrap is flexible and very easy to use,
  ...
  },
  {
    ...
    post_title: 'Here is why Wireframes are important for your project planning',
    post_contents: `Using wireframes early on in the design process forces you and your clients to look objectively at ease of use, conversion paths, element placement and helps point out flaws early. These are all things that lead to intuitive, functional and delightful products.`,
    user_id: 'be88bf2d-e41e-4fa0-937d-7e252cc73404'
  },
  {
    id: 'da50e7ec-3dda-41fd-9273-3f6e0f0d7bd7',
    post_title: 'What is MVC Architecture',
    post_contents: `The Model-View-Controller (MVC) is an architectural pattern that separates an application into three main logical components: the model, the view, and the controller.`,
